...
func (s *service) CreateCampaign(input CreateCampaignInput) (Campaign, error) {
	...
	campaign.ShortDesc = input.ShrotDesc
...
func (s *service) UpdateCampaign(inputID GetCampaignDetailInput, inputData CreateCampaignInput) (Campaign, error) {
	...
	if campaign.UserID != inputData.User.ID {
		return campaign, errors.New("Owner not recognized")
	}

	campaign.Name = inputData.Name
	campaign.ShortDesc = inputData.ShrotDesc
...
func (s *service) CreateCampaignImage(input CreateCampaignImageInput, fileLocation string) (CampaignImage, error) {
	...
	if campaign.UserID != input.User.ID {
		return CampaignImage{}, errors.New("Owner not recognized")
	}
